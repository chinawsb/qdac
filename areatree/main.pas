...
type
  ...
  TForm3 = class(TForm)
    ...
    Label1: TLabel;
    Timer1: TTimer;
    QVTCustomCheckCell1: TQVTCustomCheckCell;
    ...
    procedure QVTCustomCheckCell1GetStates(ASender: TObject;
      var AStates: TQVTCheckStates);
    procedure QVirtualTreeView1GetCellDrawer(Sender: TQVirtualTreeView;
...
procedure TForm3.QVirtualTreeView1GetCellDrawer(Sender: TQVirtualTreeView;
  ANode: TQVTNode; ACol: Integer; var ADrawer: IQVTDrawer);
begin
...
procedure TForm3.QVTCustomCheckCell1GetStates(ASender: TObject;
  var AStates: TQVTCheckStates);
begin
  //
end;
