...
uses System.Classes, System.SysUtils, System.Character, System.TypInfo, System.Generics.Defaults, System.Generics.Collections, System.RegularExpressionsCore, System.Rtti, qdac.common;
...
// Currency 内部是 Int64 按 10000 缩放，MinValue/MaxValue 的常量本身会导致算术溢出
// 使用内部表示避免编译器常量折叠
var ACurrencyMin, ACurrencyMax: Currency;
PInt64(@ACurrencyMin)^ := System.Low(Int64); // -9223372036854775808 → Currency.MinValue
PInt64(@ACurrencyMax)^ := System.High(Int64); // 9223372036854775807 → Currency.MaxValue
RegisterRangeValidator<Currency>(ACurrencyMin, ACurrencyMax);
end;
