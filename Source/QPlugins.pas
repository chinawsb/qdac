...
/// <summary>
/// 使用默认方式生成一个 IQService 服务接口
/// </summary>
/// <param name="AId">服务的GUID唯一编码</param>
/// <param name="AName">服务的名称</param>
/// <param name="AInstance">提供服务的实例</param>
/// <returns>返回生成的服务接口</returns>
...
/// <param name="AId">服务的GUID唯一编码</param>
/// <param name="AName">服务的名称</param>
/// <param name="AInstance">提供服务的实例获取接口</param>
/// <returns>返回生成的服务接口</returns>
function NewService(const AId: TGuid; const AName: QStringW;
