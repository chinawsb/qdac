...
uses Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.TypInfo, System.Rtti, System.Generics.Collections, System.DateUtils, System.VarCmplx, Data.FMTBcd, System.Classes, Vcl.Graphics, System.JSON, System.Diagnostics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, qdac.common, qdac.attribute, qdac.serialize.core, qdac.JSON.core, Vcl.StdCtrls, Vcl.Buttons, Vcl.ExtCtrls;
...
const
  ...
  begin
    ...
    Memo1.Update;
    var ABytes := TEncoding.utf8.GetBytes(AText);
...
begin
  ...
  Memo1.Update;
  var AData: TBytes := TEncoding.utf8.GetBytes(AJsonText);
...
begin
  ...
  for var I := 0 to High(AList) do begin
    AList[I] := RandStr(3 + random(100));
  end;
  Memo1.Lines.Add('System.Hashset testing...');
  Memo1.Update;
  var ASet := TDictionary<string, Integer>.Create;
  D1 := TThread.GetTickCount;
  for var I := 0 to High(AList) do
    ASet.AddOrSetValue(AList[I], 0);
  D1 := TThread.GetTickCount - D1;
  FreeAndNil(ASet);
...
begin
  ...
  ATime := Now;
  for var I := 0 to High(AOrders) do begin
...
begin
  ...
  var AFormat := TQJsonEncoder.DefaultFormat;
